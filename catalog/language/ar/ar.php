...
$_['error_upload_size']     = 'تحذير: الملف الذي تم تحميله يتجاوز الحد الأقصى لحجم الملف٪ smb!';
$_['error_curl']            = 'CURL: رمز الخطأ (%s): %s';
$_['error_session']         = 'تحذير: انتهت الجلسة ، يرجى إرسال النموذج مرة أخرى!';

// custom
$_['shop_now']      		= 'تسوق الآن';
$_['offer_title']      		= 'احصل على صفقة خاصة اليوم! احصل على 3 منتجات مقابل 2. عرض محدود.<b>اقرأ أكثر</b>';
$_['contact_desc']          =  'دعم 24/7';
$_['cat_hed']    			= 'الفئة';
