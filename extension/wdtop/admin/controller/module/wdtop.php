...
namespace Opencart\Admin\Controller\Extension\Wdtop\Module;
use \Opencart\System\Helper AS Helper;

class Wdtop extends \Opencart\System\Engine\Controller {

	private string $extensionPath = 'extension/wdtop/module/wdtop';
	...
	public function save(): void {
		...
		if (!$json) {
			...
			if (!isset($this->request->get['module_id'])) {
				$this->model_setting_module->addModule('wdtop.wdtop', $this->request->post);
			} else {
