...
namespace Opencart\Admin\Controller\Extension\Wdonsale\Module;
use \Opencart\System\Helper AS Helper;

class Wdonsale extends \Opencart\System\Engine\Controller {

	private string $extensionPath = 'extension/wdonsale/module/wdonsale';
	...
	public function save(): void {
		...
		if (!$json) {
			...
			if (!isset($this->request->get['module_id'])) {
				$this->model_setting_module->addModule('wdonsale.wdonsale', $this->request->post);
			} else {
