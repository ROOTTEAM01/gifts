...
function db_schema() {
    ...
    $tables[] = [
        ...
        'field' => [
            ...
            [
                'name' => 'defined_products_more',
                'type' => 'varchar(255)',
                'not_null' => true,                
            ],
            [
                'name' => 'only_selected_language',
                'type' => 'int(11)',
                'not_null' => true,                
            ],
            [
	...
	$tables[] = [
        'name' => 'workdonewsletter_subscribe',
        'field' => [
            [
                'name' => 'subscribe_id',
                'type' => 'int(11)',
    ...
    $tables[] = [
        'name' => 'workdonewsletter_template',
        'field' => [
            [
                'name' => 'template_id',
                'type' => 'int(11)',
    ...
    $tables[] = [
        'name' => 'workdonewsletter_template_description',
        'field' => [
            [
                'name' => 'template_id',
                'type' => 'int(11)',
