        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            echo "</td>
                  ...
                  <tbody>
                    ";
            // line 60
            if ((($__internal_compile_0 = ($context["banner_images"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 60)] ?? null) : null)) {
                // line 61
                echo "                      ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable((($__internal_compile_1 = ($context["banner_images"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 61)] ?? null) : null));
                foreach ($context['_seq'] as $context["_key"] => $context["banner_image"]) {
                    ...
                    echo ($context["image_row"] ?? null);
                    echo "][title]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "title", [], "any", false, false, false, 66);
                    echo "\" placeholder=\"";
                    echo ($context["entry_title"] ?? null);
                    echo "\" id=\"input-image-";
                    echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 66);
                    ...
                    echo ($context["image_row"] ?? null);
                    echo "][link]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "link", [], "any", false, false, false, 70);
                    echo "\" placeholder=\"";
                    echo ($context["entry_link"] ?? null);
                    echo "\" id=\"input-image-";
                    echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 70);
                    ...
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "description", [], "any", false, false, false, 73);
                    echo "</textarea></td>
                          ...
                          <td class=\"text-center\">
                            ...
                            <div class=\"card\">
                              ...
                              <img src=\"";
                    // line 79
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "thumb", [], "any", false, false, false, 79);
                    ...
                    echo ($context["image_row"] ?? null);
                    echo "][image]\" value=\"";
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "image", [], "any", false, false, false, 80);
                    echo "\" id=\"input-image-";
                    echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 80);
                    echo "-";
                    echo ($context["image_row"] ?? null);
                    ...
                    echo twig_get_attribute($this->env, $this->source, $context["banner_image"], "sort_order", [], "any", false, false, false, 90);
                    echo "\" placeholder=\"";
                    echo ($context["entry_sort_order"] ?? null);
                    echo "\" id=\"input-image-";
                    echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 90);
...
\$('button[id^=\\'button-banner\\']').on('click', function () {
    ...
    html += '  <td class=\"text-start\"><textarea type=\"text\" name=\"banner_image[' + \$(element).attr('data-language') + '][' + image_row + '][description]\" value=\"\" placeholder=\"";
        // line 126
        echo ($context["entry_description"] ?? null);
        echo "\"  data-toggle=\"summernote\" data-oc-toggle=\"ckeditor\" id=\"input-image-' + \$(element).attr('data-language') + '-' + image_row + '-description\" class=\"form-control wb-'+ image_row +'\"/></textarea></td>';
...
";
    ...
    {
        return array (  493 => 151,  477 => 138,  473 => 137,  466 => 133,  462 => 132,  454 => 129,  448 => 126,  444 => 125,  439 => 123,  430 => 117,  418 => 108,  415 => 107,  391 => 101,  385 => 97,  382 => 96,  376 => 95,  374 => 94,  366 => 91,  352 => 90,  337 => 84,  327 => 83,  313 => 80,  303 => 79,  288 => 73,  272 => 70,  264 => 67,  250 => 66,  244 => 63,  241 => 62,  236 => 61,  234 => 60,  226 => 55,  222 => 54,  218 => 53,  213 => 51,  209 => 50,  203 => 47,  194 => 46,  176 => 45,  174 => 44,  170 => 42,  143 => 40,  126 => 39,  115 => 33,  108 => 29,  98 => 24,  93 => 22,  88 => 20,  83 => 18,  76 => 13,  65 => 11,  61 => 10,  56 => 8,  50 => 7,  46 => 6,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "admin/view/template/design/banner_form.twig", "C:\\xampp\\htdocs\\gifts-quickstart\\admin\\view\\template\\design\\banner_form.twig");
    }
}
